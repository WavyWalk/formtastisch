...
export function SharingFormState() {
  return (
    <>
...
function PropertyData({
  ...
  // here this component got state through props, and it will subscribe to it's changes
  formState.use();
...
// if your PO ever asks you "let's put half form in body and half in header", formtastisch got you covered without any contextes
